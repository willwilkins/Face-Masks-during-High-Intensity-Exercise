...
time_of_day = 'Evening'
test_time = '18-55'
mask_config = 'HTP STM-6010'

#unmasked_rest_file = r''
#missing the file for 21-03-16 18:35 - will edit to assume HRrest = 54

masked_rest_file = r'C:/Users/Willi/OneDrive - University of Cambridge/Engineering/IIB/IIB Project/Experimental Data/CSV Files/O2Ring_20210316184124.csv'
recovery_file = r'C:/Users/Willi/OneDrive - University of Cambridge/Engineering/IIB/IIB Project/Experimental Data/CSV Files/O2Ring_20210316185504.csv'
...
"""
#couldn't find the rest file
HRrest = 54#min(restHRData) # lowest observed heart rate during the rest period beforehand
print('HRrest:', HRrest)
