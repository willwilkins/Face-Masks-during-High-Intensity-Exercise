...
time_of_day = 'Evening'
test_time = '21-23'
mask_config = 'Baltic Masks BM-001'

unmasked_rest_file = r'C:/Users/Willi/OneDrive - University of Cambridge/Engineering/IIB/IIB Project/Experimental Data/Participant 3/BM001/Evening/O2Ring_20210318211250.csv'
...
recovery_file = r'C:/Users/Willi/OneDrive - University of Cambridge/Engineering/IIB/IIB Project/Experimental Data/Participant 3/BM001/Evening/O2Ring_20210318212351.csv'
...
lamda_opt = 0.23 # the lamda's which give global minima
...
ax1.scatter(lamda_opt, ff.f(lamda_opt, L0, HRrecovery, timesRecovery, HRrest, age, sex),  s=80, c='r', marker='o', 
            label='\lambda fitted by eye = {:0.2f} ± 0.01$'.format(lamda_opt))
ax1.legend()
...
costGraph.savefig('..\Cost Functions\(By Eye, lamda=0.23) P{} {} {} {} {} Impulse Recovery Lamda Fitting Cost Function.png'.format(ptcpt_no, test_date, test_time, time_of_day, mask_config))
...
#ax2.text(1, 1,'{} {}'.format())
plt.show()
time_series.savefig('..\Time Series Plots\(By Eye, lamda=0.23) P{} {} {} {} {} Impulse Recovery Time Series.png'.format(ptcpt_no, test_date, test_time, time_of_day, mask_config))
