...
time_of_day = 'Morning'
test_time = '9-28'
mask_config = '(HaloPlus Mask Day)'

unmasked_rest_file = r'C:/Users/Willi/OneDrive - University of Cambridge/Engineering/IIB/IIB Project/Experimental Data/Participant 3/HaloPlus 03-29/Morning/O2Ring_20210329091510.csv'
...
recovery_file = r'C:/Users/Willi/OneDrive - University of Cambridge/Engineering/IIB/IIB Project/Experimental Data/Participant 3/HaloPlus 03-29/Morning/O2Ring_20210329092813.csv'
...
ax1.scatter(lamda_opt, costs.min(), s=80, c='r', marker='o', 
            label='Global Minimum at $\hat \lambda = {:0.3f} ± 0.002$'.format(lamda_opt))
ax1.legend()
...
costGraph.savefig('..\Cost Functions\P{} {} {} L0 = {} {} {} Impulse Recovery Lamda Fitting Cost Function.png'.format(ptcpt_no, test_date, test_time, L0, time_of_day, mask_config))
...
#ax2.text(1, 1,'{} {}'.format())
plt.show()
time_series.savefig('..\Time Series Plots\P{} {} {} L0 = {} {} {} Impulse Recovery Time Series.png'.format(ptcpt_no, test_date, test_time, L0, time_of_day, mask_config))
